...
VkFormat GetVKFormat(RenderFormat format)
{
	switch (format)
	{
	case RenderFormat::UNKNOWN: return VK_FORMAT_UNDEFINED;
	case RenderFormat::R32G32B32A32_TYPELESS: return VK_FORMAT_R32G32B32A32_UINT;
	...
	case RenderFormat::R32G32B32_TYPELESS:		return VK_FORMAT_R32G32B32_UINT;
	...
	case RenderFormat::R16G16B16A16_TYPELESS:	return VK_FORMAT_R16G16B16A16_UINT;
	...
	case RenderFormat::R32G32_TYPELESS:		return VK_FORMAT_R32G32_UINT;
	...
	case RenderFormat::R32G8X24_TYPELESS:			return VK_FORMAT_D32_SFLOAT_S8_UINT;// TODO: Translation might be wrong
	case RenderFormat::D32_FLOAT_S8X24_UINT:		return VK_FORMAT_D32_SFLOAT_S8_UINT;// TODO: Translation might be wrong
	case RenderFormat::R32_FLOAT_X8X24_TYPELESS:	return VK_FORMAT_D32_SFLOAT_S8_UINT;// TODO: Translation might be wrong
	case RenderFormat::X32_TYPELESS_G8X24_UINT:	return VK_FORMAT_D32_SFLOAT_S8_UINT;// TODO: Translation might be wrong
	case RenderFormat::R10G10B10A2_TYPELESS:	return VK_FORMAT_A2B10G10R10_UINT_PACK32;
	...
	case RenderFormat::R8G8B8A8_TYPELESS:	return VK_FORMAT_R8G8B8A8_UINT;
	...
	case RenderFormat::R16G16_TYPELESS:	return VK_FORMAT_R16G16_UINT;
	...
	case RenderFormat::R32_TYPELESS:		return VK_FORMAT_R32_UINT;
	...
	case RenderFormat::R24G8_TYPELESS:		return VK_FORMAT_D24_UNORM_S8_UINT;
	...
	case RenderFormat::R8G8_TYPELESS:	return VK_FORMAT_R8G8_UINT;
	...
	case RenderFormat::R16_TYPELESS:	return VK_FORMAT_R16_UINT;
	...
	case RenderFormat::R8_TYPELESS:	return VK_FORMAT_R8_UINT;
	...
	case RenderFormat::A8_UNORM:		return VK_FORMAT_R8_UNORM; 
	case RenderFormat::R1_UNORM:		return VK_FORMAT_R8_UNORM; // There is no 1-bit format in Vulkan, using 8-bit instead
	...
	case RenderFormat::BC1_TYPELESS:	return VK_FORMAT_BC1_RGBA_UNORM_BLOCK;
	...
	case RenderFormat::BC2_TYPELESS:	return VK_FORMAT_BC2_UNORM_BLOCK;
	...
	case RenderFormat::BC3_TYPELESS:	return VK_FORMAT_BC3_UNORM_BLOCK;
	...
	case RenderFormat::BC4_TYPELESS:	return VK_FORMAT_BC4_UNORM_BLOCK;
	case RenderFormat::BC4_UNORM:		return VK_FORMAT_BC4_UNORM_BLOCK;
	case RenderFormat::BC4_SNORM:		return VK_FORMAT_BC4_SNORM_BLOCK;
	case RenderFormat::BC5_TYPELESS:	return VK_FORMAT_BC5_UNORM_BLOCK;
	case RenderFormat::BC5_UNORM:		return VK_FORMAT_BC5_UNORM_BLOCK;
	case RenderFormat::BC5_SNORM:		return VK_FORMAT_BC5_SNORM_BLOCK;
	case RenderFormat::B5G6R5_UNORM:	return VK_FORMAT_R5G6B5_UNORM_PACK16;
	case RenderFormat::B5G5R5A1_UNORM:	return VK_FORMAT_A1R5G5B5_UNORM_PACK16;
	case RenderFormat::B8G8R8A8_UNORM:	return VK_FORMAT_B8G8R8A8_UNORM;
	case RenderFormat::B8G8R8X8_UNORM:	return VK_FORMAT_B8G8R8A8_UNORM; // There is no B8G8R8X8 format in Vulkan, using B8G8R8A8 instead
	case RenderFormat::R10G10B10_XR_BIAS_A2_UNORM:	return VK_FORMAT_A2B10G10R10_UNORM_PACK32;
	case RenderFormat::B8G8R8A8_TYPELESS:	return VK_FORMAT_B8G8R8A8_UINT;
	case RenderFormat::B8G8R8A8_UNORM_SRGB:return VK_FORMAT_B8G8R8A8_SRGB;
	case RenderFormat::B8G8R8X8_TYPELESS:	return VK_FORMAT_B8G8R8A8_UINT; // There is no B8G8R8X8 format in Vulkan, using B8G8R8A8 instead
	case RenderFormat::B8G8R8X8_UNORM_SRGB:	return VK_FORMAT_B8G8R8A8_SRGB; // There is no B8G8R8X8 format in Vulkan, using B8G8R8A8 instead
	case RenderFormat::BC6H_TYPELESS:	return VK_FORMAT_BC6H_UFLOAT_BLOCK;
	...
	case RenderFormat::BC7_TYPELESS:	return VK_FORMAT_BC7_UNORM_BLOCK;
	...
	case RenderFormat::B4G4R4A4_UNORM:	return VK_FORMAT_UNDEFINED; // These formats do not have direct equivalents in Vulkan
	case RenderFormat::COUNT:
	case RenderFormat::BIT_MASK:
