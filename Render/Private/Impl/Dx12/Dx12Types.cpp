...
D3D12_DESCRIPTOR_RANGE_TYPE Dx12_DescriptorRangeType(RootSignatureDescriptorTableType type)
{
    switch (type)
    {
    case RootSignatureDescriptorTableType::SRV: return D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
    case RootSignatureDescriptorTableType::UAV: return D3D12_DESCRIPTOR_RANGE_TYPE_UAV;
    }

    assert(0 && "Dx12_DescriptorRangeType unsupported range type");

    return (D3D12_DESCRIPTOR_RANGE_TYPE)0u;
}
...
D3D12_PRIMITIVE_TOPOLOGY Dx12_PrimitiveTopology(PrimitiveTopologyType ptt)
{
    ...
    case PrimitiveTopologyType::POINT: return D3D_PRIMITIVE_TOPOLOGY_POINTLIST;
    ...
    assert(0 && "Dx12_PrimitiveTopology unsupported type");
