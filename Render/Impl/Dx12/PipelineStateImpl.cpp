...
static D3D12_BLEND GetBlend(BlendType b)
{
	...
	case BlendType::SrcColor:		return D3D12_BLEND_SRC_COLOR;
	case BlendType::InvSrcColor:	return D3D12_BLEND_INV_SRC_COLOR;
	case BlendType::SrcAlpha:		return D3D12_BLEND_SRC_ALPHA;
	case BlendType::InvSrcAlpha:	return D3D12_BLEND_INV_SRC_ALPHA;
	case BlendType::DstAlpha:		return D3D12_BLEND_DEST_ALPHA;
	case BlendType::InvDstAlpha:	return D3D12_BLEND_INV_DEST_ALPHA;
	case BlendType::DstColor:		return D3D12_BLEND_DEST_COLOR;
	case BlendType::InvDstColor:	return D3D12_BLEND_INV_DEST_COLOR;
	case BlendType::SrcAlphaSat:	return D3D12_BLEND_SRC_ALPHA_SAT;
	}
...
static D3D12_COMPARISON_FUNC GetComparisonFunc(ComparisionFunc f)
{
	...
	case ComparisionFunc::LessEqual:	return D3D12_COMPARISON_FUNC_LESS_EQUAL;
	case ComparisionFunc::Greater:		return D3D12_COMPARISON_FUNC_GREATER;
	case ComparisionFunc::NotEqual:		return D3D12_COMPARISON_FUNC_NOT_EQUAL;
	case ComparisionFunc::GreaterEqual:	return D3D12_COMPARISON_FUNC_GREATER_EQUAL;
...
static D3D12_INPUT_CLASSIFICATION GetInputClassification(InputClassification ic)
{
	switch (ic)
	{
	case InputClassification::PerVertex: return D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA;
	case InputClassification::PerInstance: return D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA;
	}
...
bool CompileComputePipelineState(ComputePipelineState_t handle, const ComputePipelineStateDesc& desc)
{
	...
	{
		assert(0 && "CompileComputePipelineState needs a valid vertex shader");
		return false;
	}
